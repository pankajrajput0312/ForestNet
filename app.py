...
putout_model =  tf.keras.models.load_model('Weights/putout.h5', compile = True)
cause_model =  tf.keras.models.load_model('Weights/cause.h5')
...
def localize():
    if(request.method == 'POST'):
        ...
        image.save("static/assets/img/image_name.jpg")
        print("OK")
        model.predict("./static/assets/img/image_name.jpg")
